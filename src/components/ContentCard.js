...
export default function ContentCard() {
    return (
        <div class="flex flex-row items-center min-h-fit border-2 border-white hover:skew-y-3 hover:-skew-x-3 m-5 sm:w-full md:w-3/4 lg:w-1/4 hover:p-2 bg-black p-4 rounded-lg transition-all ease-in-out duration-75">
